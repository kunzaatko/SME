...
\begin{hypothesis}[Nerovnost mezi velikostmi pizz firem]
	...
	\[
		\E [D_{\text{\emph{EagleBoys}}}] > \E [D_{\text{\emph{Domino's}}}].
	\]
\end{hypothesis}
\begin{hypothesis}[Velikost 12 palců]
	...
	\[
		\E [D_{\text{\emph{EagleBoys}}}] \ge \SI{30.48}{\cm}.
	\]
\end{hypothesis}
...
Podíváme se na četnosti zastoupení jednotlivých kategorií pizz v nasbíraných datech v kontingenčních tabulkách. Nejprve jednotlivě pro firmy a obě kategorie druhu pizz, abychom ověřili, jestli určité typy kůrky určují preferenci určité přísady a naopak.
...
\begin{hypothesis}[Nerovnost mezi \emph{ThinCrust} a \emph{MidCrust}]
	...
	\[
		\E\left[D_{\text{\emph{EagleBoys}}} \mid C = \text{\emph{ThinCrust}} \right] > \E\left[ D_{\text{\emph{EagleBoys}}} \mid C = \text{\emph{MidCrust}}\right].
	\]
\end{hypothesis}
...
\begin{hypothesis}[Nerovnost mezi \emph{ThinNCrispy} a \emph{ClassicCrust}]
	...
	\[
		\E\left[D_{\text{\emph{Domino's}}} \mid C = \text{\emph{ThinNCrispy}} \right] > \E\left[ D_{\text{\emph{Domino's}}} \mid C = \text{\emph{ClassicCrust}}\right].
	\]
\end{hypothesis}
...
\begin{hypothesis}[Nerovnost mezi \emph{ThinCrust} a \emph{DeepPan}]
	...
	\[
		\E\left[D_{\text{\emph{EagleBoys}}} \mid C = \text{\emph{ThinCrust}} \right] > \E\left[ D_{\text{\emph{EagleBoys}}} \mid C = \text{\emph{DeepPan}}\right].
	\]
\end{hypothesis}
